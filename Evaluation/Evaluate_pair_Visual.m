...
%         targetPath = '../data/evaluation/Visual/2-4/4_opt1.swc';
        ...
        sourcePath = ['../data/evaluation/Visual/2-4/',temp,'_opt.swc'];%00760_Opt.swc';%
        temp=StackList{targetID,1};
        targetPath = ['../data/evaluation/Visual/2-4/',temp,'_opt.swc'];%00759_Opt.swc';%
...
% Rigid
    FeaturePositions = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Visual_StackList\MatchedPoints_Rigid.mat');
...
%        hold on; PlotAM(AM_Target,r_Target,'r')
    ...
    FeaturePositions = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Visual_StackList\StackPositions_Registered.mat');
...
FeaturePositions = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Visual_StackList\MatchedPoints_Affine.mat');
