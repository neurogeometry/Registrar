function [L,b, Match_Indexes,RandomSamples] = RANSAC_3D_Rigid(SourceLocations,TargetLocations)
% ============================== About ====================================
% -------------------------------------------------------------------------
% Purpose: 3D Ransac
% Input: 
...
while  length(CorrectNumbers) < NumCorrectNeeded && i < FailLimit
    ...
    AllDistances = sum((SourceLocations_Rigid-TargetLocations).^2,1).^0.5;
