...
ResultFolder = 'data\Table1_MouseLight\';
...
AffineMU(mm,1) = mu;
NRMU(mm,1) = mu;
AffineMU(mm,2) =mean(M_Affine(:,1))
NRMU(mm,2) = mean(M_NonRigid(:,1))
mm =mm +1;
end
...
M_Old1 = M_Old(:,1);
M_Translation1 = M_Translation(:,1);
M_Rigid1 = M_Rigid(:,1);
M_Affine1 = M_Affine(:,1);
M_NonRigid1 = M_NonRigid(:,1);
