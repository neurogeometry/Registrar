...
for Dataset = DatasetList
    ...
    if strcmp(Dataset,'Holtmaat')
        ...
        Evaluation_csv_pth = 'C:\Users\Seyed\Documents\DatasetTests\Final_pixel_newFeatures\data\evaluation\Holtmaat\Holtmaat_Evaluation.csv';
        pad = [0 0 0];
        
        FeaturePositions_T = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Holtmaat_StackList\MatchedPoints_Translation.mat');
        FeaturePositions_R = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Holtmaat_StackList\MatchedPoints_Rigid.mat');
        FeaturePositions_A = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Holtmaat_StackList\MatchedPoints_Affine.mat');
    ...
    elseif strcmp(Dataset,'Neuromuscular')
        ...
        Evaluation_csv_pth = 'C:\Users\Seyed\Documents\DatasetTests\Final_pixel_newFeatures\data\evaluation\DIADEM_Neuro\Neuro_Evaluation.csv';
        ...
        FeaturePositions_T = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neuromuscular_StackList_4Stacks\MatchedPoints_Translation.mat');
        FeaturePositions_R = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neuromuscular_StackList_4Stacks\MatchedPoints_Rigid.mat');
        FeaturePositions_A = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neuromuscular_StackList_4Stacks\MatchedPoints_Affine.mat');
    ...
    elseif strcmp(Dataset,'Neocortical_1')
        ...
        Evaluation_csv_pth = 'C:\Users\Seyed\Documents\DatasetTests\Final_pixel_newFeatures\data\evaluation\DIADEM_Neo1\Neo1_Evaluation.csv';
        pad = [0 0 0];
        
        FeaturePositions_T = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neocortical1_StackList\MatchedPoints_Translation.mat');
        FeaturePositions_R = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neocortical1_StackList\MatchedPoints_Rigid.mat');
        FeaturePositions_A = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neocortical1_StackList\MatchedPoints_Affine.mat');
        StackPositions_pixels = StackPositions_pixels(:,[2,1,3]);
        
    elseif strcmp(Dataset,'Neocortical_2')
        pixelSize = [0.3 0.3 1.02];
        load('../data/StackData_DIADEM2.mat');
        Evaluation_csv_pth = 'C:\Users\Seyed\Documents\DatasetTests\Final_pixel_newFeatures\data\evaluation\DIADEM_Neo2\Neo2_Evaluation.csv';
        
        FeaturePositions_T = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neocortical2_StackList\MatchedPoints_Translation.mat');
        FeaturePositions_R = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neocortical2_StackList\MatchedPoints_Rigid.mat');
        FeaturePositions_A = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Neocortical2_StackList\MatchedPoints_Affine.mat');
        pad = [0 0 0];
    ...
    elseif strcmp(Dataset,'MouseLight')
        ...
        Evaluation_csv_pth = 'C:\Users\Seyed\Documents\NeurogeometryLab\NeurogeometryLab\Seyed\Evaluation\data\evaluation\MouseLight\MouseLight_Evaluation.csv';
        
        FeaturePositions_T = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-MouseLight_StackList\MatchedPoints_Translation.mat');
        FeaturePositions_R = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-MouseLight_StackList\MatchedPoints_Rigid.mat');
        FeaturePositions_A = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-MouseLight_StackList\MatchedPoints_Affine.mat');
    ...
    elseif strcmp(Dataset,'Visual')
        ...
        Evaluation_csv_pth = 'C:\Users\Seyed\Documents\DatasetTests\Final_pixel_newFeatures\data\evaluation\Visual\Visual_Evaluation.csv';
        pad = [0 0 0];
        
        
        FeaturePositions_T = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Visual_StackList\MatchedPoints_Translation.mat');
        FeaturePositions_R = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Visual_StackList\MatchedPoints_Rigid.mat');
        FeaturePositions_A = load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-Visual_StackList\MatchedPoints_Affine.mat');
    ...
    for k = 1: size(EvaluationInfo,1)
        ...
        FeaturePositions_T.Matched{sourceID,targetID}(:,1:3)-FeaturePositions_T.Matched{sourceID,targetID}(:,4:6)
...
%                         axis equal
        ...
        corr_Translation = caclulateCorr(Source_StackPositions+b',Target_StackPositions,IM_Source,IM_Target,pad,showCorr);
        ...
        corr_Rigid = caclulateCorr((R*Source_StackPositions'+b)',Target_StackPositions,IM_Source,IM_Target,pad,showCorr);
        ...
        if CalculateOtherMEthods
            ...
            corr_Fiji = caclulateCorr([0,0,0],[dy_Fiji,dx_Fiji,dz_Fiji],IM_Source,IM_Target,pad,showCorr);
    ...
    All_voxels(db,:) = [mean(M_Old(db,:,1)),mean(M_XUV(db,:,1)),mean(M_Tera(db,:,1)),mean(M_Fiji(db,:,1)),mean(M_Translation(db,:,1)),mean(M_Rigid(db,:,1)),mean(M_Affine(db,:,1)),mean(M_NonRigid(db,:,1))]
    All_um(db,:) = [mean(M_Old(db,:,2)),mean(M_XUV(db,:,2)),mean(M_Tera(db,:,2)),mean(M_Fiji(db,:,2)),mean(M_Translation(db,:,2)),mean(M_Rigid(db,:,2)),mean(M_Affine(db,:,2)),mean(M_NonRigid(db,:,2))]
    All_corr(db,:) = [mean(M_Old(db,:,3)),mean(M_XUV(db,:,3)),mean(M_Tera(db,:,3)),mean(M_Fiji(db,:,3)),mean(M_Translation(db,:,3)),mean(M_Rigid(db,:,3)),mean(M_Affine(db,:,3)),mean(M_NonRigid(db,:,3))]
...
% load('C:\Users\Seyed\Documents\DatasetTests\GUI\NCT_Registration\MicroscopeFiles\Results-MouseLight_StackList\StackPositions_Registered.mat');
