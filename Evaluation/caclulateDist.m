...
for i = 1:size(result,2)
    ...
    for j = 1:size(result{1,i}.Trace.AM1,2)
        ...
        [Dis_fiji_Affine_um,Dis_fiji_Affine_voxel] = TraceDistance(result{1,i}.Trace.AM1{j}, result{1,i}.Trace.r1_fiji_Affine{j}, result{1,i}.Trace.AM2{j}, result{1,i}.Trace.r2{j},pixelSize,0);
...
for i = 1:size(result,2)
    ...
    hold on
    d_bouton_fiji_Affine = result{1,i}.Bouton.r1_fiji_Affine-result{1,i}.Bouton.r2;
