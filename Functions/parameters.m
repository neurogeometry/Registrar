...
params.FE.windowsize = [10 10 5];

%  Feature Extraction Threshold - higher k for less features
params.FE.k = -1;

% Expected number of features per stack
params.FE.MaxN_Features=2000;
params.FE.Mesh = [10 10 5]; %Features distance / Higher for less Features
...
DBAddress = 'C:\Users\Seyed\Documents\DatasetTests\registrar/nctracer.db';
