 ...
 * <pre>
 *  /Users/chuhan/Documents/study/2019Spring/registrar/JavaMapReduce/FeatureExtraction.m
 * </pre>
...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    /**
     * Maintains information used in calling the <code>FeatureExtraction</code> MATLAB 
     *function.
     */
    private static final MWFunctionSignature sFeatureExtractionSignature =
    ...
    {
        this(FeatureExtractionMCRFactory.newInstance());
    }
    ...
    {
        this(FeatureExtractionMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(FeatureExtractionMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = FeatureExtractionMCRFactory.newInstance();
            mcr.runMain( sFeatureExtractionSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>FeatureExtraction</code> MATLAB function 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FeatureExtraction(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFeatureExtractionSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FeatureExtraction(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFeatureExtractionSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FeatureExtraction</code> MATLAB function with 
     * 1 input argument.
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FeatureExtraction(Object... rhs) throws MWException
    {
        Object[] lhs = new Object[0];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFeatureExtractionSignature), 
                    sFeatureExtractionSignature);
        return lhs;
    }
}
