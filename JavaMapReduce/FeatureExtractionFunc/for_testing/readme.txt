FeatureExtractionFunc MATLAB Java Package
...
- FeatureExtractionFunc.jar must be included in your CLASSPATH.
...
-MCRInstaller.zip 
    ...
    Deployment Tool.
-Javadoc   
   - javadoc for FeatureExtractionFunc is in the doc directory. When  
