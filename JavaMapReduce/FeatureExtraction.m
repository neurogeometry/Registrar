...
%   For Mac/Unix
    ...
    IM_Original=ImportStack(char(tifFile),StackSizes_pixels_csv(i,:));
    FeatureExtractionFunc(IM_Original,i,DataFolder,StackPositions_pixels_csv(overlap_ind,:),StackSizes_pixels_csv(overlap_ind,:));
end